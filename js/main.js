...
(function () {
  ...
  pilulasTam.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      // Pílula ativa + descrição saem da MESMA função usada ao abrir a tela, para o
      // clique e a abertura nunca discordarem (era essa divergência o bug do texto errado).
      sincronizarTamanhoTemporadaNBA();
    });
  });
})();
