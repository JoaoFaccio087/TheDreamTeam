...
// ═══════════════════════════════════════════════════════════════════
// A camada de UI/fluxo da campanha de BASQUETE foi movida para
// js/campanha-basquete-ui.js (reduz o monolito). As funções continuam
// globais, então o resto do código as acessa normalmente.
// ═══════════════════════════════════════════════════════════════════


// Força média de uma seleção (0-100), usada para resolver jogos neutros na chave.
// ═══════════════════════════════════════════════════════════════════
// A camada de UI/fluxo da campanha de VÔLEI foi movida para
// js/campanha-volei-ui.js (reduz o monolito). As funções continuam
// globais, então o resto do código as acessa normalmente.
// ═══════════════════════════════════════════════════════════════════
