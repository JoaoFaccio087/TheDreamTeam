...
const DADOS_SERIE_A = [
  ...
  // ══════════════════════════════════════════════════════════════════════════
  //  Edição 2012 (temporada 2011-12) — a JUVENTUS de Antonio CONTE campeã INVICTA
  //  (84 pts, 23 V e 15 E, 0 derrotas), o 28º título e o 1º da era pós-Calciopoli,
  //  a primeira campanha sem derrotas no formato de 38 jogos. Pirlo chegou de graça
  //  do Milan e formou meio-campo histórico com Vidal e Marchisio. Top-6: Juventus
  //  (84), Milan (80), Udinese (64), Lazio (62), Napoli (61), Inter (58). Ibrahimović
  //  (Milan) foi artilheiro (28 gols). Foi o renascimento da Juve como potência.
  // ══════════════════════════════════════════════════════════════════════════

  {
    ...
    jogadores: [
      ...
      { id: 'paolo-de-ceglie',     nome: "Paolo De Ceglie",     posicoes: ["LE","MD"],   forca: 76 },
      { id: 'arturo-vidal',        nome: "Arturo Vidal",        posicoes: ["VOL","MC"],  forca: 85 },
      { id: 'andrea-pirlo',        nome: "Andrea Pirlo",        posicoes: ["MC","VOL"],  forca: 87 },
      { id: 'claudio-marchisio',   nome: "Claudio Marchisio",   posicoes: ["MC","VOL"],  forca: 83 },
      { id: 'mauricio-isla',       nome: "Mauricio Isla",       posicoes: ["LD","MD"],   forca: 78 },
      { id: 'alessandro-del-piero', nome: "Alessandro Del Piero", posicoes: ["MEI","ATA"], forca: 82 },
      { id: 'mirko-vucinic',       nome: "Mirko Vučinić",       posicoes: ["ATA","MEI"], forca: 81 },
      { id: 'fabio-quagliarella',  nome: "Fabio Quagliarella",  posicoes: ["ATA"],       forca: 80 },
      { id: 'marco-borriello',     nome: "Marco Borriello",     posicoes: ["ATA"],       forca: 77 }
    ]
  },

  {
    ...
    jogadores: [
      { id: 'christian-abbiati',   nome: "Christian Abbiati",   posicoes: ["GOL"],       forca: 82 },
      { id: 'ignazio-abate',       nome: "Ignazio Abate",       posicoes: ["LD","MD"],   forca: 79 },
      { id: 'thiago-silva',        nome: "Thiago Silva",        posicoes: ["ZAG"],       forca: 88 },
      { id: 'alessandro-nesta',    nome: "Alessandro Nesta",    posicoes: ["ZAG"],       forca: 82 },
      { id: 'philippe-mexes',      nome: "Philippe Mexès",      posicoes: ["ZAG"],       forca: 79 },
      { id: 'luca-antonini',       nome: "Luca Antonini",       posicoes: ["LE","MD"],   forca: 76 },
      { id: 'massimo-ambrosini',   nome: "Massimo Ambrosini",   posicoes: ["MC","VOL"],  forca: 78 },
      { id: 'mark-van-bommel',     nome: "Mark van Bommel",     posicoes: ["VOL","MC"],  forca: 80 },
      { id: 'kevin-prince-boateng', nome: "Kevin-Prince Boateng", posicoes: ["MC","MEI"], forca: 80 },
      { id: 'clarence-seedorf',    nome: "Clarence Seedorf",    posicoes: ["MC","MEI"],  forca: 80 },
      { id: 'antonio-nocerino',    nome: "Antonio Nocerino",    posicoes: ["MC","VOL"],  forca: 78 },
      { id: 'zlatan-ibrahimovic',  nome: "Zlatan Ibrahimović",  posicoes: ["ATA"],       forca: 88 },
      { id: 'robinho',             nome: "Robinho",             posicoes: ["ATA","PE"],  forca: 81 },
...

  {
    ...
    jogadores: [
      ...
      { id: 'maurizio-domizzi',    nome: "Maurizio Domizzi",    posicoes: ["ZAG","LE"],  forca: 76 },
      { id: 'dusan-basta',         nome: "Dušan Basta",         posicoes: ["LD","MD"],   forca: 78 },
      { id: 'kwadwo-asamoah',      nome: "Kwadwo Asamoah",      posicoes: ["MC","LE"],   forca: 81 },
      { id: 'giampiero-pinzi',     nome: "Giampiero Pinzi",     posicoes: ["VOL","MC"],  forca: 76 },
      { id: 'emmanuel-badu',       nome: "Emmanuel Agyemang-Badu", posicoes: ["MC","VOL"], forca: 77 },
      { id: 'pablo-armero',        nome: "Pablo Armero",        posicoes: ["LE","MD"],   forca: 78 },
      { id: 'antonio-di-natale',   nome: "Antonio Di Natale",   posicoes: ["ATA"],       forca: 84 },
      { id: 'diego-fabbrini',      nome: "Diego Fabbrini",      posicoes: ["MEI","ATA"], forca: 75 },
      { id: 'matej-vydra',         nome: "Matěj Vydra",         posicoes: ["ATA"],       forca: 76 },
      { id: 'giovanni-pasquale',   nome: "Giovanni Pasquale",   posicoes: ["LE","LD"],   forca: 75 },
      { id: 'almen-abdi',          nome: "Almen Abdi",          posicoes: ["MEI","MC"],  forca: 76 }
    ]
  },

  {
    ...
    jogadores: [
      ...
      { id: 'lorik-cana',          nome: "Lorik Cana",          posicoes: ["VOL","ZAG"], forca: 78 },
      { id: 'cristian-ledesma',    nome: "Cristian Ledesma",    posicoes: ["VOL","MC"],  forca: 79 },
      { id: 'hernanes',            nome: "Hernanes",            posicoes: ["MEI","MC"],  forca: 83 },
      ...
      { id: 'tommaso-rocchi',      nome: "Tommaso Rocchi",      posicoes: ["ATA"],       forca: 76 },
      { id: 'libor-kozak',         nome: "Libor Kozák",         posicoes: ["ATA"],       forca: 75 },
      { id: 'stefano-mauri',       nome: "Stefano Mauri",       posicoes: ["MEI","MC"],  forca: 77 },
      { id: 'abdoulay-konko',      nome: "Abdoulay Konko",      posicoes: ["LD","ZAG"],  forca: 76 }
    ]
  },

  {
    ...
    jogadores: [
      ...
      { id: 'marek-hamsik',        nome: "Marek Hamšík",        posicoes: ["MEI","MC"],  forca: 84 },
      { id: 'ezequiel-lavezzi',    nome: "Ezequiel Lavezzi",    posicoes: ["ATA","MEI"], forca: 83 },
      { id: 'edinson-cavani',      nome: "Edinson Cavani",      posicoes: ["ATA"],       forca: 88 },
      { id: 'goran-pandev',        nome: "Goran Pandev",        posicoes: ["ATA","MEI"], forca: 78 },
      { id: 'blerim-dzemaili',     nome: "Blerim Džemaili",     posicoes: ["MC","MEI"],  forca: 76 },
      { id: 'andrea-dossena',      nome: "Andrea Dossena",      posicoes: ["LE","MD"],   forca: 75 }
    ]
  },

  {
    ...
    jogadores: [
      { id: 'julio-cesar',         nome: "Júlio César",         posicoes: ["GOL"],       forca: 85 },
      { id: 'maicon',              nome: "Maicon",              posicoes: ["LD","MD"],   forca: 82 },
      { id: 'lucio',               nome: "Lúcio",               posicoes: ["ZAG"],       forca: 81 },
      { id: 'walter-samuel',       nome: "Walter Samuel",       posicoes: ["ZAG"],       forca: 82 },
      { id: 'javier-zanetti',      nome: "Javier Zanetti",      posicoes: ["LD","VOL"],  forca: 82 },
      { id: 'chivu',               nome: "Cristian Chivu",      posicoes: ["ZAG","LE"],  forca: 78 },
      { id: 'esteban-cambiasso',   nome: "Esteban Cambiasso",   posicoes: ["VOL","MC"],  forca: 83 },
      { id: 'thiago-motta',        nome: "Thiago Motta",        posicoes: ["MC","VOL"],  forca: 80 },
      { id: 'wesley-sneijder',     nome: "Wesley Sneijder",     posicoes: ["MEI","MC"],  forca: 84 },
      { id: 'joel-obi',            nome: "Joel Obi",            posicoes: ["MC","ME"],   forca: 75 },
      { id: 'diego-milito',        nome: "Diego Milito",        posicoes: ["ATA"],       forca: 83 },
      { id: 'giampaolo-pazzini',   nome: "Giampaolo Pazzini",   posicoes: ["ATA"],       forca: 80 },
      { id: 'diego-forlan',        nome: "Diego Forlán",        posicoes: ["ATA","MEI"], forca: 80 },
      { id: 'mauro-zarate',        nome: "Mauro Zárate",        posicoes: ["ATA","MEI"], forca: 77 }
    ]
  },

  // ══════════════════════════════════════════════════════════════════════════
  //  Edição 2013 (temporada 2012-13) — a JUVENTUS de Conte bicampeã (87 pts), 29º
  //  título, com a defesa BBC (Barzagli-Bonucci-Chiellini) e Pogba recém-chegado de
  //  graça. Top-6: Juventus (87), Napoli (78), Milan (72), Fiorentina (70), Udinese
  //  (66), Roma (62). Cavani foi artilheiro (29 gols) na despedida do Napoli antes do
  //  PSG. A Fiorentina de Montella, com Jovetić e Gómez, encantou. Foi a última
  //  temporada de Del Piero, El Shaarawy explodiu no Milan (16 gols no 1º turno).
  // ══════════════════════════════════════════════════════════════════════════

  {
    ...
    jogadores: [
      ...
      { id: 'andrea-pirlo',        nome: "Andrea Pirlo",        posicoes: ["MC","VOL"],  forca: 87 },
      { id: 'claudio-marchisio',   nome: "Claudio Marchisio",   posicoes: ["MC","VOL"],  forca: 84 },
      { id: 'paul-pogba',          nome: "Paul Pogba",          posicoes: ["MC","VOL"],  forca: 82 },
      { id: 'kwadwo-asamoah',      nome: "Kwadwo Asamoah",      posicoes: ["MC","LE"],   forca: 80 },
      { id: 'mirko-vucinic',       nome: "Mirko Vučinić",       posicoes: ["ATA","MEI"], forca: 80 },
      { id: 'sebastian-giovinco',  nome: "Sebastian Giovinco",  posicoes: ["ATA","MEI"], forca: 79 },
      { id: 'fabio-quagliarella',  nome: "Fabio Quagliarella",  posicoes: ["ATA"],       forca: 79 },
      { id: 'mauricio-isla',       nome: "Mauricio Isla",       posicoes: ["LD","MD"],   forca: 77 }
    ]
  },

  {
    ...
    jogadores: [
      { id: 'morgan-de-sanctis',   nome: "Morgan De Sanctis",   posicoes: ["GOL"],       forca: 81 },
      { id: 'paolo-cannavaro',     nome: "Paolo Cannavaro",     posicoes: ["ZAG"],       forca: 78 },
      { id: 'federico-fernandez',  nome: "Federico Fernández",  posicoes: ["ZAG"],       forca: 79 },
      { id: 'hugo-campagnaro',     nome: "Hugo Campagnaro",     posicoes: ["ZAG"],       forca: 78 },
      { id: 'christian-maggio',    nome: "Christian Maggio",    posicoes: ["LD","MD"],   forca: 79 },
      { id: 'juan-camilo-zuniga',  nome: "Juan Zúñiga",         posicoes: ["LD","MD"],   forca: 78 },
      { id: 'walter-gargano',      nome: "Walter Gargano",      posicoes: ["VOL","MC"],  forca: 78 },
      ...
      { id: 'edinson-cavani',      nome: "Edinson Cavani",      posicoes: ["ATA"],       forca: 88 },
      { id: 'goran-pandev',        nome: "Goran Pandev",        posicoes: ["ATA","MEI"], forca: 78 },
      { id: 'lorenzo-insigne',     nome: "Lorenzo Insigne",     posicoes: ["ATA","MEI"], forca: 79 },
      { id: 'blerim-dzemaili',     nome: "Blerim Džemaili",     posicoes: ["MC","MEI"],  forca: 76 }
    ]
  },

  {
    ...
    jogadores: [
      ...
      { id: 'philippe-mexes',      nome: "Philippe Mexès",      posicoes: ["ZAG"],       forca: 79 },
      { id: 'cristian-zapata',     nome: "Cristián Zapata",     posicoes: ["ZAG"],       forca: 78 },
      { id: 'kevin-constant',      nome: "Kevin Constant",      posicoes: ["LE","VOL"],  forca: 76 },
      { id: 'massimo-ambrosini',   nome: "Massimo Ambrosini",   posicoes: ["MC","VOL"],  forca: 77 },
      { id: 'riccardo-montolivo',  nome: "Riccardo Montolivo",  posicoes: ["MC","MEI"],  forca: 81 },
      { id: 'sulley-muntari',      nome: "Sulley Muntari",      posicoes: ["MC","VOL"],  forca: 78 },
      { id: 'kevin-prince-boateng', nome: "Kevin-Prince Boateng", posicoes: ["MC","MEI"], forca: 80 },
      { id: 'stephan-el-shaarawy', nome: "Stephan El Shaarawy", posicoes: ["ATA","PE"],  forca: 82 },
      { id: 'giampaolo-pazzini',   nome: "Giampaolo Pazzini",   posicoes: ["ATA"],       forca: 80 },
      { id: 'mbaye-niang',         nome: "M'Baye Niang",        posicoes: ["ATA"],       forca: 75 },
      { id: 'bojan-krkic',         nome: "Bojan Krkić",         posicoes: ["ATA","MEI"], forca: 77 },
      { id: 'mattia-de-sciglio',   nome: "Mattia De Sciglio",   posicoes: ["LD","LE"],   forca: 77 }
    ]
  },

  {
    ...
    clube: "Fiorentina",
    jogadores: [
      { id: 'emiliano-viviano',    nome: "Emiliano Viviano",    posicoes: ["GOL"],       forca: 79 },
      ...
      { id: 'facundo-roncaglia',   nome: "Facundo Roncaglia",   posicoes: ["ZAG","LD"],  forca: 76 },
      { id: 'manuel-pasqual',      nome: "Manuel Pasqual",      posicoes: ["LE","MD"],   forca: 77 },
      { id: 'borja-valero',        nome: "Borja Valero",        posicoes: ["MC","MEI"],  forca: 82 },
      { id: 'david-pizarro',       nome: "David Pizarro",       posicoes: ["MC","MEI"],  forca: 79 },
      { id: 'alberto-aquilani',    nome: "Alberto Aquilani",    posicoes: ["MC","MEI"],  forca: 79 },
      { id: 'juan-cuadrado',       nome: "Juan Cuadrado",       posicoes: ["PD","MD"],   forca: 79 },
      { id: 'stevan-jovetic',      nome: "Stevan Jovetić",      posicoes: ["MEI","ATA"], forca: 83 },
      { id: 'mario-gomez',         nome: "Mario Gómez",         posicoes: ["ATA"],       forca: 83 },
      { id: 'luca-toni',           nome: "Luca Toni",           posicoes: ["ATA"],       forca: 77 },
      { id: 'adem-ljajic',         nome: "Adem Ljajić",         posicoes: ["MEI","ATA"], forca: 78 },
      { id: 'alessandro-gamberini', nome: "Alessandro Gamberini", posicoes: ["ZAG"],      forca: 78 }
    ]
  },

  {
    ...
    clube: "Udinese",
    jogadores: [
      { id: 'zeljko-brkic',        nome: "Željko Brkić",        posicoes: ["GOL"],       forca: 77 },
      { id: 'mehdi-benatia',       nome: "Mehdi Benatia",       posicoes: ["ZAG"],       forca: 82 },
      { id: 'danilo',              nome: "Danilo",              posicoes: ["ZAG"],       forca: 78 },
      { id: 'thomas-heurtaux',     nome: "Thomas Heurtaux",     posicoes: ["ZAG"],       forca: 76 },
      { id: 'maurizio-domizzi',    nome: "Maurizio Domizzi",    posicoes: ["ZAG","LE"],  forca: 76 },
      { id: 'giampiero-pinzi',     nome: "Giampiero Pinzi",     posicoes: ["VOL","MC"],  forca: 76 },
      { id: 'emmanuel-badu',       nome: "Emmanuel Agyemang-Badu", posicoes: ["MC","VOL"], forca: 77 },
      { id: 'allan',               nome: "Allan",               posicoes: ["VOL","MC"],  forca: 78 },
      { id: 'roberto-pereyra',     nome: "Roberto Pereyra",     posicoes: ["MEI","MC"],  forca: 79 },
      { id: 'antonio-di-natale',   nome: "Antonio Di Natale",   posicoes: ["ATA"],       forca: 83 },
      { id: 'luis-muriel',         nome: "Luis Muriel",         posicoes: ["ATA"],       forca: 78 },
      { id: 'maicosuel',           nome: "Maicosuel",           posicoes: ["MEI","ATA"], forca: 76 },
      { id: 'dusan-basta',         nome: "Dušan Basta",         posicoes: ["LD","MD"],   forca: 77 },
      { id: 'pablo-armero',        nome: "Pablo Armero",        posicoes: ["LE","MD"],   forca: 78 }
    ]
  },

  {
    ...
    clube: "Roma",
    jogadores: [
      { id: 'mauro-goicoechea',    nome: "Mauro Goicoechea",    posicoes: ["GOL"],       forca: 76 },
      { id: 'marco-cassetti',      nome: "Marco Cassetti",      posicoes: ["LD","ZAG"],  forca: 76 },
      ...
      { id: 'miralem-pjanic',      nome: "Miralem Pjanić",      posicoes: ["MC","MEI"],  forca: 82 },
      { id: 'alessandro-florenzi', nome: "Alessandro Florenzi", posicoes: ["MC","MD"],   forca: 78 },
      { id: 'panagiotis-tachtsidis', nome: "Panagiotis Tachtsidis", posicoes: ["VOL","MC"], forca: 76 },
      { id: 'francesco-totti',     nome: "Francesco Totti",     posicoes: ["MEI","ATA"], forca: 84 },
      { id: 'erik-lamela',         nome: "Erik Lamela",         posicoes: ["PD","MEI"],  forca: 81 },
      { id: 'pablo-osvaldo',       nome: "Pablo Osvaldo",       posicoes: ["ATA"],       forca: 80 },
  ...
  // ══════════════════════════════════════════════════════════════════════════
  //  Edição 2017 (temporada 2016-17) — a JUVENTUS de Allegri HEXACAMPEÃ (91 pts), 33º
  //  título e a dobradinha com a Coppa Italia, no ano em que também foi VICE da
  //  Champions (perdeu a final para o Real Madrid em Cardiff). Higuaín reforçou a Juve
  //  vindo do Napoli. Top-6: Juventus (91), Roma (87), Napoli (86), Atalanta (72),
  //  Lazio (70), Milan (63). Džeko (Roma) foi artilheiro (29 gols). A ATALANTA de
  //  Gasperini foi a revelação (4º, à Europa) e entra no acervo com Gómez e Caldara.
  // ══════════════════════════════════════════════════════════════════════════

  {
    ...
    jogadores: [
      { id: 'gianluigi-buffon',    nome: "Gianluigi Buffon",    posicoes: ["GOL"],       forca: 89 },
      { id: 'dani-alves',          nome: "Dani Alves",          posicoes: ["LD","MD"],   forca: 83 },
      { id: 'leonardo-bonucci',    nome: "Leonardo Bonucci",    posicoes: ["ZAG"],       forca: 87 },
      { id: 'giorgio-chiellini',   nome: "Giorgio Chiellini",   posicoes: ["ZAG","LE"],  forca: 87 },
      { id: 'andrea-barzagli',     nome: "Andrea Barzagli",     posicoes: ["ZAG"],       forca: 82 },
      { id: 'alex-sandro',         nome: "Alex Sandro",         posicoes: ["LE","MD"],   forca: 84 },
      { id: 'miralem-pjanic',      nome: "Miralem Pjanić",      posicoes: ["MC","MEI"],  forca: 84 },
      ...
      { id: 'mario-mandzukic',     nome: "Mario Mandžukić",     posicoes: ["ATA","PE"],  forca: 83 },
      { id: 'juan-cuadrado',       nome: "Juan Cuadrado",       posicoes: ["PD","MD"],   forca: 82 },
      { id: 'stefano-sturaro',     nome: "Stefano Sturaro",     posicoes: ["MC","VOL"],  forca: 77 }
    ]
  },

  {
    ...
    jogadores: [
      ...
      { id: 'federico-fazio',      nome: "Federico Fazio",      posicoes: ["ZAG"],       forca: 80 },
      { id: 'kostas-manolas',      nome: "Kostas Manolas",      posicoes: ["ZAG"],       forca: 83 },
      { id: 'antonio-rudiger',     nome: "Antonio Rüdiger",     posicoes: ["ZAG","LD"],  forca: 81 },
      { id: 'emerson-palmieri',    nome: "Emerson Palmieri",    posicoes: ["LE","MD"],   forca: 78 },
      { id: 'daniele-de-rossi',    nome: "Daniele De Rossi",    posicoes: ["VOL","MC"],  forca: 81 },
      { id: 'radja-nainggolan',    nome: "Radja Nainggolan",    posicoes: ["MC","VOL"],  forca: 85 },
      { id: 'kevin-strootman',     nome: "Kevin Strootman",     posicoes: ["MC","VOL"],  forca: 80 },
      { id: 'alessandro-florenzi', nome: "Alessandro Florenzi", posicoes: ["LD","MC"],   forca: 79 },
      { id: 'mohamed-salah',       nome: "Mohamed Salah",       posicoes: ["PD","ATA"],  forca: 85 },
      { id: 'edin-dzeko',          nome: "Edin Džeko",          posicoes: ["ATA"],       forca: 85 },
...

  {
    ...
    jogadores: [
      { id: 'pepe-reina',          nome: "Pepe Reina",          posicoes: ["GOL"],       forca: 81 },
      { id: 'elseid-hysaj',        nome: "Elseid Hysaj",        posicoes: ["LD","LE"],   forca: 78 },
      { id: 'kalidou-koulibaly',   nome: "Kalidou Koulibaly",   posicoes: ["ZAG"],       forca: 84 },
      { id: 'raul-albiol',         nome: "Raúl Albiol",         posicoes: ["ZAG"],       forca: 80 },
      { id: 'faouzi-ghoulam',      nome: "Faouzi Ghoulam",      posicoes: ["LE","MD"],   forca: 81 },
      { id: 'jorginho',            nome: "Jorginho",            posicoes: ["VOL","MC"],  forca: 82 },
      { id: 'allan',               nome: "Allan",               posicoes: ["VOL","MC"],  forca: 81 },
      { id: 'marek-hamsik',        nome: "Marek Hamšík",        posicoes: ["MEI","MC"],  forca: 84 },
      { id: 'jose-callejon',       nome: "José Callejón",       posicoes: ["PD","ATA"],  forca: 82 },
      { id: 'lorenzo-insigne',     nome: "Lorenzo Insigne",     posicoes: ["ATA","MEI"], forca: 84 },
      { id: 'dries-mertens',       nome: "Dries Mertens",       posicoes: ["ATA","MEI"], forca: 85 },
      { id: 'piotr-zielinski',     nome: "Piotr Zieliński",     posicoes: ["MC","MEI"],  forca: 80 },
      { id: 'arkadiusz-milik',     nome: "Arkadiusz Milik",     posicoes: ["ATA"],       forca: 79 },
      { id: 'emanuele-giaccherini', nome: "Emanuele Giaccherini", posicoes: ["MEI","MD"], forca: 77 }
    ]
  },

  {
    ...
    jogadores: [
      ...
      { id: 'mattia-caldara',      nome: "Mattia Caldara",      posicoes: ["ZAG"],       forca: 80 },
      { id: 'rafael-toloi',        nome: "Rafael Tolói",        posicoes: ["ZAG","LD"],  forca: 79 },
      { id: 'andrea-masiello',     nome: "Andrea Masiello",     posicoes: ["ZAG"],       forca: 77 },
      { id: 'leonardo-spinazzola', nome: "Leonardo Spinazzola", posicoes: ["LE","MD"],   forca: 79 },
      ...
      { id: 'remo-freuler',        nome: "Remo Freuler",        posicoes: ["MC","VOL"],  forca: 79 },
      { id: 'roberto-gagliardini', nome: "Roberto Gagliardini", posicoes: ["MC","VOL"],  forca: 78 },
      { id: 'alejandro-gomez',     nome: "Alejandro Gómez",     posicoes: ["MEI","PE"],  forca: 83 },
      { id: 'andrea-petagna',      nome: "Andrea Petagna",      posicoes: ["ATA"],       forca: 78 },
      { id: 'andrea-conti',        nome: "Andrea Conti",        posicoes: ["LD","MD"],   forca: 78 },
      { id: 'franck-kessie',       nome: "Franck Kessié",       posicoes: ["MC","VOL"],  forca: 79 },
      { id: 'jasmin-kurtic',       nome: "Jasmin Kurtić",       posicoes: ["MC","MEI"],  forca: 76 }
    ]
  },

  {
    ...
    jogadores: [
      ...
      { id: 'wallace',             nome: "Wallace",             posicoes: ["ZAG"],       forca: 76 },
      { id: 'stefan-radu',         nome: "Ștefan Radu",         posicoes: ["ZAG","LE"],  forca: 78 },
      { id: 'senad-lulic',         nome: "Senad Lulić",         posicoes: ["LE","ME"],   forca: 79 },
      { id: 'dusan-basta',         nome: "Dušan Basta",         posicoes: ["LD","MD"],   forca: 77 },
      { id: 'lucas-biglia',        nome: "Lucas Biglia",        posicoes: ["VOL","MC"],  forca: 81 },
      { id: 'sergej-milinkovic-savic', nome: "Sergej Milinković-Savić", posicoes: ["MC","MEI"], forca: 81 },
      { id: 'marco-parolo',        nome: "Marco Parolo",        posicoes: ["MC","VOL"],  forca: 80 },
      { id: 'felipe-anderson',     nome: "Felipe Anderson",     posicoes: ["PD","MEI"],  forca: 81 },
      { id: 'ciro-immobile',       nome: "Ciro Immobile",       posicoes: ["ATA"],       forca: 84 },
      { id: 'keita-balde',         nome: "Keita Baldé",         posicoes: ["ATA","PE"],  forca: 80 },
      { id: 'luis-alberto',        nome: "Luis Alberto",        posicoes: ["MEI","MC"],  forca: 78 },
      { id: 'wesley-hoedt',        nome: "Wesley Hoedt",        posicoes: ["ZAG"],       forca: 76 }
    ]
  },

  {
    ...
    clube: "Milan",
    jogadores: [
      { id: 'gianluigi-donnarumma', nome: "Gianluigi Donnarumma", posicoes: ["GOL"],     forca: 82 },
      { id: 'ignazio-abate',       nome: "Ignazio Abate",       posicoes: ["LD","MD"],   forca: 77 },
      ...
      { id: 'mattia-de-sciglio',   nome: "Mattia De Sciglio",   posicoes: ["LD","LE"],   forca: 77 },
      { id: 'juraj-kucka',         nome: "Juraj Kucka",         posicoes: ["MC","VOL"],  forca: 78 },
      { id: 'manuel-locatelli',    nome: "Manuel Locatelli",    posicoes: ["MC","VOL"],  forca: 77 },
      { id: 'giacomo-bonaventura', nome: "Giacomo Bonaventura", posicoes: ["MC","MEI"],  forca: 80 },
      { id: 'suso',                nome: "Suso",                posicoes: ["PD","MEI"],  forca: 80 },
      { id: 'carlos-bacca',        nome: "Carlos Bacca",        posicoes: ["ATA"],       forca: 80 },
      { id: 'mbaye-niang',         nome: "M'Baye Niang",        posicoes: ["ATA","PD"],  forca: 77 },
      { id: 'gerard-deulofeu',     nome: "Gerard Deulofeu",     posicoes: ["PE","ATA"],  forca: 78 },
      { id: 'riccardo-montolivo',  nome: "Riccardo Montolivo",  posicoes: ["MC","MEI"],  forca: 78 },
      { id: 'vangelis-moras',      nome: "Vangelis Moras",      posicoes: ["ZAG"],       forca: 74 }
    ]
  },

  // ══════════════════════════════════════════════════════════════════════════
  //  Edição 2018 (temporada 2017-18) — a JUVENTUS de Allegri HEPTACAMPEÃ (95 pts),
  //  34º título e o 7º SEGUIDO (recorde), com nova dobradinha Coppa Italia. O NAPOLI
  //  de Sarri fez 91 pts (a maior pontuação de um vice na história) com o "sarrismo"
  //  encantando a Europa, mas caiu na reta final. Top-6: Juventus (95), Napoli (91),
  //  Roma (77), Inter (72), Lazio (72), Milan (64). Icardi (Inter) e Immobile (Lazio)
  //  dividiram a artilharia (29 gols). A Roma foi à semi da Champions (eliminou o Barça).
  // ══════════════════════════════════════════════════════════════════════════

  {
    ...
    jogadores: [
      { id: 'gianluigi-buffon',    nome: "Gianluigi Buffon",    posicoes: ["GOL"],       forca: 88 },
      { id: 'mattia-de-sciglio',   nome: "Mattia De Sciglio",   posicoes: ["LD","LE"],   forca: 78 },
      { id: 'medhi-benatia',       nome: "Medhi Benatia",       posicoes: ["ZAG"],       forca: 82 },
      { id: 'giorgio-chiellini',   nome: "Giorgio Chiellini",   posicoes: ["ZAG","LE"],  forca: 87 },
      { id: 'andrea-barzagli',     nome: "Andrea Barzagli",     posicoes: ["ZAG"],       forca: 82 },
      { id: 'alex-sandro',         nome: "Alex Sandro",         posicoes: ["LE","MD"],   forca: 84 },
      { id: 'miralem-pjanic',      nome: "Miralem Pjanić",      posicoes: ["MC","MEI"],  forca: 85 },
      { id: 'sami-khedira',        nome: "Sami Khedira",        posicoes: ["VOL","MC"],  forca: 82 },
      { id: 'blaise-matuidi',      nome: "Blaise Matuidi",      posicoes: ["MC","VOL"],  forca: 82 },
      { id: 'paulo-dybala',        nome: "Paulo Dybala",        posicoes: ["MEI","ATA"], forca: 87 },
      { id: 'gonzalo-higuain',     nome: "Gonzalo Higuaín",     posicoes: ["ATA"],       forca: 87 },
      { id: 'mario-mandzukic',     nome: "Mario Mandžukić",     posicoes: ["ATA","PE"],  forca: 83 },
...

  {
    ...
    jogadores: [
      { id: 'pepe-reina',          nome: "Pepe Reina",          posicoes: ["GOL"],       forca: 82 },
      { id: 'elseid-hysaj',        nome: "Elseid Hysaj",        posicoes: ["LD","LE"],   forca: 79 },
      ...
      { id: 'marek-hamsik',        nome: "Marek Hamšík",        posicoes: ["MEI","MC"],  forca: 84 },
      { id: 'jose-callejon',       nome: "José Callejón",       posicoes: ["PD","ATA"],  forca: 82 },
      { id: 'lorenzo-insigne',     nome: "Lorenzo Insigne",     posicoes: ["ATA","MEI"], forca: 85 },
      { id: 'dries-mertens',       nome: "Dries Mertens",       posicoes: ["ATA","MEI"], forca: 85 },
      { id: 'piotr-zielinski',     nome: "Piotr Zieliński",     posicoes: ["MC","MEI"],  forca: 81 },
      { id: 'amadou-diawara',      nome: "Amadou Diawara",      posicoes: ["VOL","MC"],  forca: 77 },
      { id: 'arkadiusz-milik',     nome: "Arkadiusz Milik",     posicoes: ["ATA"],       forca: 79 }
    ]
  },

  {
    ...
    jogadores: [
      ...
      { id: 'kostas-manolas',      nome: "Kostas Manolas",      posicoes: ["ZAG"],       forca: 83 },
      { id: 'juan-jesus',          nome: "Juan Jesus",          posicoes: ["ZAG","LE"],  forca: 77 },
      { id: 'aleksandar-kolarov',  nome: "Aleksandar Kolarov",  posicoes: ["LE","MD"],   forca: 81 },
      { id: 'alessandro-florenzi', nome: "Alessandro Florenzi", posicoes: ["LD","MC"],   forca: 78 },
      { id: 'daniele-de-rossi',    nome: "Daniele De Rossi",    posicoes: ["VOL","MC"],  forca: 80 },
      { id: 'radja-nainggolan',    nome: "Radja Nainggolan",    posicoes: ["MC","VOL"],  forca: 84 },
      { id: 'kevin-strootman',     nome: "Kevin Strootman",     posicoes: ["MC","VOL"],  forca: 80 },
      { id: 'lorenzo-pellegrini',  nome: "Lorenzo Pellegrini",  posicoes: ["MC","MEI"],  forca: 79 },
...

  {
    ...
    jogadores: [
      { id: 'samir-handanovic',    nome: "Samir Handanović",    posicoes: ["GOL"],       forca: 85 },
      { id: 'joao-miranda',        nome: "Miranda",             posicoes: ["ZAG"],       forca: 81 },
      { id: 'milan-skriniar',      nome: "Milan Škriniar",      posicoes: ["ZAG"],       forca: 82 },
      { id: 'danilo-dambrosio',    nome: "Danilo D'Ambrosio",   posicoes: ["LD","ZAG"],  forca: 78 },
      { id: 'yuto-nagatomo',       nome: "Yuto Nagatomo",       posicoes: ["LE","MD"],   forca: 76 },
      { id: 'marcelo-brozovic',    nome: "Marcelo Brozović",    posicoes: ["VOL","MC"],  forca: 81 },
      { id: 'roberto-gagliardini', nome: "Roberto Gagliardini", posicoes: ["MC","VOL"],  forca: 78 },
      { id: 'joao-mario',          nome: "João Mário",          posicoes: ["MC","MEI"],  forca: 78 },
      { id: 'antonio-candreva',    nome: "Antonio Candreva",    posicoes: ["MD","MEI"],  forca: 80 },
      { id: 'ivan-perisic',        nome: "Ivan Perišić",        posicoes: ["PE","MEI"],  forca: 82 },
      { id: 'mauro-icardi',        nome: "Mauro Icardi",        posicoes: ["ATA"],       forca: 86 },
      { id: 'matias-vecino',       nome: "Matías Vecino",       posicoes: ["MC","VOL"],  forca: 79 },
      { id: 'rafinha',             nome: "Rafinha",             posicoes: ["MEI","MC"],  forca: 79 },
      { id: 'eder',                nome: "Éder",                posicoes: ["ATA"],       forca: 77 }
    ]
  },

  {
    ...
    jogadores: [
      ...
      { id: 'stefan-radu',         nome: "Ștefan Radu",         posicoes: ["ZAG","LE"],  forca: 78 },
      { id: 'bastos',              nome: "Bastos",              posicoes: ["ZAG"],       forca: 77 },
      { id: 'senad-lulic',         nome: "Senad Lulić",         posicoes: ["LE","ME"],   forca: 79 },
      { id: 'adam-marusic',        nome: "Adam Marušić",        posicoes: ["LD","MD"],   forca: 77 },
      { id: 'lucas-leiva',         nome: "Lucas Leiva",         posicoes: ["VOL","MC"],  forca: 81 },
      ...
      { id: 'marco-parolo',        nome: "Marco Parolo",        posicoes: ["MC","VOL"],  forca: 79 },
      { id: 'ciro-immobile',       nome: "Ciro Immobile",       posicoes: ["ATA"],       forca: 86 },
      { id: 'felipe-anderson',     nome: "Felipe Anderson",     posicoes: ["PD","MEI"],  forca: 81 },
      { id: 'nani',                nome: "Nani",                posicoes: ["PE","ATA"],  forca: 78 },
      { id: 'jordan-lukaku',       nome: "Jordan Lukaku",       posicoes: ["LE","MD"],   forca: 75 }
    ]
  },

  {
    ...
    clube: "Milan",
    jogadores: [
      { id: 'gianluigi-donnarumma', nome: "Gianluigi Donnarumma", posicoes: ["GOL"],     forca: 83 },
      { id: 'davide-calabria',     nome: "Davide Calabria",     posicoes: ["LD","MD"],   forca: 76 },
      { id: 'leonardo-bonucci',    nome: "Leonardo Bonucci",    posicoes: ["ZAG"],       forca: 84 },
      { id: 'alessio-romagnoli',   nome: "Alessio Romagnoli",   posicoes: ["ZAG"],       forca: 81 },
      { id: 'ricardo-rodriguez',   nome: "Ricardo Rodríguez",   posicoes: ["LE","MD"],   forca: 79 },
      { id: 'franck-kessie',       nome: "Franck Kessié",       posicoes: ["MC","VOL"],  forca: 80 },
      { id: 'lucas-biglia',        nome: "Lucas Biglia",        posicoes: ["VOL","MC"],  forca: 79 },
      { id: 'giacomo-bonaventura', nome: "Giacomo Bonaventura", posicoes: ["MC","MEI"],  forca: 80 },
      ...
      { id: 'nikola-kalinic',      nome: "Nikola Kalinić",      posicoes: ["ATA"],       forca: 78 },
